 ...
 */
@NonNullByDefault
public final class TextRetrievalProcess extends InitializationProcess {
     ...
     */
    public TextRetrievalProcess(final ArrayListMultimap<String, String> parameters) throws TemplateParseException, ResolutionException {
        super(parameters);
