...
/**
 * Class inheriting from {@link Exception} that is used to signal exceptions specific to the
 * resolution process or the initialization of components critical to this process.
 *
 * @author Eric Tobias [eric.tobias@list.lu]
 * @since 0.7
 * @version 0.7.2
 */
final public class ResolutionException extends Exception {
    private static final long serialVersionUID = -4227115240295031098L;
