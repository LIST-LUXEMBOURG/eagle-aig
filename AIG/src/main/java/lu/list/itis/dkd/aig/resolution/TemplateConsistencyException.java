 ...
 * @version 0.8.0
 */
public class TemplateConsistencyException extends Exception {

    private static final long serialVersionUID = -8314616476204776924L;
     ...
     */
    public TemplateConsistencyException(final String message) {
        super(message);
    }
     ...
     *        unknown.)
     */
    public TemplateConsistencyException(final Throwable cause) {
        super(cause);
    }
     ...
     *        unknown.)
     */
    public TemplateConsistencyException(final String message, final Throwable cause) {
        super(message, cause);
    }
}