...
public class GermanClozeTest {
    ...
    public void cApproach() {
        ...
        final Key key9 = clozeText.getClozeSentences().get(1).getKeys().get(8);
        final Key key10 = clozeText.getClozeSentences().get(1).getKeys().get(9);
    ...
    public void verbApproach() {
        ...
        final Key key3 = clozeText.getClozeSentences().get(2).getKeys().get(0);
        ...
        final Key key4 = clozeText.getClozeSentences().get(5).getKeys().get(0);
        ...
        final Key key5 = clozeText.getClozeSentences().get(9).getKeys().get(0);
        Assert.assertEquals("kann", key5.getKeyWord().getContent());
        ...
        final Key key6 = clozeText.getClozeSentences().get(9).getKeys().get(1);
    ...
    public void kodaApproach() {
        ...
        final Key key4 = clozeText.getClozeSentences().get(3).getKeys().get(0);
        ...
        final Key key5 = clozeText.getClozeSentences().get(5).getKeys().get(0);
        ...
        final Key key6 = clozeText.getClozeSentences().get(5).getKeys().get(1);
        ...
        final Key key7 = clozeText.getClozeSentences().get(7).getKeys().get(0);
        ...
        final Key key8 = clozeText.getClozeSentences().get(7).getKeys().get(1);
        ...
        final Key key9 = clozeText.getClozeSentences().get(7).getKeys().get(2);
        ...
        final Key key10 = clozeText.getClozeSentences().get(8).getKeys().get(0);
        ...
        final Key key11 = clozeText.getClozeSentences().get(8).getKeys().get(1);
