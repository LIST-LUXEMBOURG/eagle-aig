...
public class ClozeSentenceProperties {

    private OntProperty content;
    private OntProperty hasKey;
    
    public ClozeSentenceProperties(OntologyHelper onto, String namespace) {
        content = onto.createProperty("content", namespace);
        hasKey = onto.createProperty("Key", namespace);
    }
