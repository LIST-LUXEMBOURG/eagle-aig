...
//        Assert.assertEquals(key2.getBestDistractors(3).get(1).getDistractor().getWord(), "a fonctionn");
...
//        Assert.assertEquals(key2.getBestDistractors(3).get(1).getDistractor().getWord(), "avez représenté");
...
//        Assert.assertEquals(key3.getBestDistractors(3).get(1).getDistractor().getWord(), "as touché appuyée");
    ...
    public void cApproach() {
        ...
        Key key20 = clozeText.getClozeSentences().get(4).getKeys().get(19);
        Key key21 = clozeText.getClozeSentences().get(4).getKeys().get(20);
        Key key22 = clozeText.getClozeSentences().get(4).getKeys().get(21);
    ...
    public void kodaApproach() {
        ...
        Key key4 = clozeText.getClozeSentences().get(1).getKeys().get(0); 
        ...
        Key key5 = clozeText.getClozeSentences().get(1).getKeys().get(1); 
        ...
        Key key6 = clozeText.getClozeSentences().get(2).getKeys().get(0); 
        ...
        Key key7 = clozeText.getClozeSentences().get(3).getKeys().get(0); 
        ...
        Key key8 = clozeText.getClozeSentences().get(3).getKeys().get(1); 
        ...
        Key key12 = clozeText.getClozeSentences().get(4).getKeys().get(3); 
...
//        Assert.assertEquals("cariste", key12.getBestDistractors(3).get(1).getDistractorWord().getContent());
//        Assert.assertEquals("électromécanicien", key12.getBestDistractors(3).get(2).getDistractorWord().getContent());

        //Key 13 & distractors in sentence 5
        Key key13 = clozeText.getClozeSentences().get(4).getKeys().get(4); 
        ...
        Key key14 = clozeText.getClozeSentences().get(4).getKeys().get(5); 
        ...
        Key key15 = clozeText.getClozeSentences().get(4).getKeys().get(6); 
        ...
        Key key16 = clozeText.getClozeSentences().get(4).getKeys().get(7); 
        ...
        Key key17 = clozeText.getClozeSentences().get(5).getKeys().get(0); 
