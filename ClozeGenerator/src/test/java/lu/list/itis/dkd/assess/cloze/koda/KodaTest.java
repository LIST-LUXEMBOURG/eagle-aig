 ...
 */
package lu.list.itis.dkd.assess.cloze.koda;
...
public class KodaTest {
    ...
    public void frenchKoda(){
        String url = "http://smartdocs.list.lu/kodaweb/rest/koda-1.0/annotate?text=Un%20ordinateur%20est%20une%20machine%20%C3%A9lectronique%20qui%20fonctionne%20par%20la%20lecture%20s%C3%A9quentielle%20d%27un%20ensemble%20d%27instructions,%20organis%C3%A9es%20en%20programmes,%20qui%20lui%20font%20ex%C3%A9cuter%20des%20op%C3%A9rations%20logiques%20et%20arithm%C3%A9tiques%20sur%20des%20chiffres%20binaires.&ontology=DBPEDIA_EN_FR";
        String source = UrlHelper.getSource(url);
        
        //Retrieve Annotations
        List<String> annotations = new ArrayList<>();
        Pattern annotationPattern = Pattern.compile("\"[a-zA-Z\\s]*\"");
  ...
  //TODO make a test
    ...
    public void enlishKoda(){
        String url = "http://smartdocs.list.lu/kodaweb/rest/koda-1.0/annotate?text=A%20computer%20is%20a%20general-purpose%20device%20that%20can%20be%20programmed%20to%20carry%20out%20a%20set%20of%20arithmetic%20or%20logical%20operations%20automatically.&ontology=DBPEDIA_EN_EN";
        String source = UrlHelper.getSource(url);
