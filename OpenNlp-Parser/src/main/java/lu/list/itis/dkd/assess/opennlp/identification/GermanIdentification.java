 ...
 * @version 1.0.1
 */
public class GermanIdentification {    
    //enumeration???
    private static final List<String> identifications = Arrays.asList(
                    "ein", "eine", "einen", "einem", "einer", "eines", "der", "den", "dem", "des", "das", "das",
                    "die", "der", "dieser", "diesen", "diesem", "dieses", "dies", "dieses", "diese", "jener",
                    "jenen", "jenem", "jenes", "jene"
    );
...
//                              System.out.println("Identification: " + identification2);
                                break;
                            }
                        }
                    }
