 ...
 * @version 2.1.1
 */
public class ConnectiveProperties {

    private OntProperty connective;
    private OntProperty type;
    private OntProperty language;
    
    public ConnectiveProperties (OntologyHelper onto, String namespace) {
        language = onto.createProperty("language", namespace);
        type = onto.createProperty("type", namespace);
        connective = onto.createProperty("connective", namespace);
    }
    ...
    public OntProperty getConnective() {
        return connective;
    }
}
