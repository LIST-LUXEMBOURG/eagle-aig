...
public class TextProperties {
    ...
    private OntProperty hasParagraph;
    private OntProperty hasSentence;
    private OntProperty hasWord;

    public TextProperties(OntologyHelper onto, String namespace) {
        ...
        summary = onto.createProperty("summary", namespace);
        ...
        //TODO rename?
        hasParagraph = onto.createProperty("hasParagraph", namespace);
    ...
    public OntProperty getHasParagraph() {
        return hasParagraph;
    }
