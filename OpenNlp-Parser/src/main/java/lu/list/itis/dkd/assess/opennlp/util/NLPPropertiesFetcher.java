 ...
 * @version 1.0.0
 */
public final class NLPPropertiesFetcher {
	private static final String NLP_PROPERTIES_FILE = "opennlp.properties";
	 private static final Properties properties = new java.util.Properties();
	
	static {
		Logger.getLogger(NLPPropertiesFetcher.class.getSimpleName()).log(Level.INFO, "Load: "+NLP_PROPERTIES_FILE);
        try {
        	properties.load(NLPPropertiesFetcher.class.getResourceAsStream(NLP_PROPERTIES_FILE));
