 ...
 * @version 1.0.0
 */
public class FrenchDependencyTest {
    
    @Test
    public void test1(){
        String phrase = "Mon chien aime bien manger des saucisses.";
        Sentence sentence = new Sentence(phrase, 1, Language.FR);
        ...
        Assert.assertEquals("det", relationTag1);
        Assert.assertEquals("suj", relationTag2);
        Assert.assertEquals("root", relationTag3);
        Assert.assertEquals("mod", relationTag4);
        Assert.assertEquals("obj", relationTag5);
        Assert.assertEquals("dep", relationTag6);
        Assert.assertEquals("obj", relationTag7);
        ...
        Assert.assertEquals(3, relationNumber4);
        Assert.assertEquals(3, relationNumber5);
        Assert.assertEquals(5, relationNumber6);
        Assert.assertEquals(6, relationNumber7);
    }
}
